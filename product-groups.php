 ...
 * Description: Create and display responsive groups of Digikala products using product and affiliate links with automatic API caching and GitHub auto-updates.
 * Version: 1.3.1
...
define( 'PRODUCT_GROUPS_VERSION', '1.3.1' );
